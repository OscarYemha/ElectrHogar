...
export const createAdminProduct = function(product, category) {
    return function() {
        return axios.post(`${API_URL}/api/admin/newproduct`, {product, category});
    };
};
...
export const deleteAdminProduct = function (product) {
    return function(){
        return axios.put(`${API_URL}/api/admin/products/destroy`, {product});
    };
};
...
export const deleteAdminCategory = function(category){
    return function(){
        return axios.put(`${API_URL}/api/admin/category/destroy`, {category});
    };
};